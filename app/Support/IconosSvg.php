...
/**
 * Fuente única de paths SVG (24x24, stroke-based) usados por <x-page-header>
 * y <x-ui.kpi-card> -- antes cada componente tenía su propia copia parcial
 * de este mapa, lo que hacía que agregar un ícono a uno no lo dejara
 * disponible en el otro. Cualquier vista nueva que necesite un ícono lo
 * agrega acá una sola vez.
 *
 * Los paths son los de Lucide (https://lucide.dev, licencia ISC), extraídos
 * 1:1 del paquete `lucide-static` (ver scripts/extract-lucide.mjs) en vez de
 * dibujados/copiados a mano -- antes eran una mezcla de distintos sets de
 * íconos con proporciones y grosor de trazo levemente distintos entre sí.
 */
class IconosSvg
{
    public const PATHS = [
        ...
        'picking' => '<rect width="8" height="4" x="8" y="2" rx="1" ry="1" /><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><path d="m9 14 2 2 4-4" />',
        'packing' => '<path d="M12 22v-9" /><path d="M15.17 2.21a1.67 1.67 0 0 1 1.63 0L21 4.57a1.93 1.93 0 0 1 0 3.36L8.82 14.79a1.655 1.655 0 0 1-1.64 0L3 12.43a1.93 1.93 0 0 1 0-3.36z" /><path d="M20 13v3.87a2.06 2.06 0 0 1-1.11 1.83l-6 3.08a1.93 1.93 0 0 1-1.78 0l-6-3.08A2.06 2.06 0 0 1 4 16.87V13" /><path d="M21 12.43a1.93 1.93 0 0 0 0-3.36L8.83 2.2a1.64 1.64 0 0 0-1.63 0L3 4.57a1.93 1.93 0 0 0 0 3.36l12.18 6.86a1.636 1.636 0 0 0 1.63 0z" />',
        ...
        'cube' => '<path d="M2.97 12.92A2 2 0 0 0 2 14.63v3.24a2 2 0 0 0 .97 1.71l3 1.8a2 2 0 0 0 2.06 0L12 19v-5.5l-5-3-4.03 2.42Z" /><path d="m7 16.5-4.74-2.85" /><path d="m7 16.5 5-3" /><path d="M7 16.5v5.17" /><path d="M12 13.5V19l3.97 2.38a2 2 0 0 0 2.06 0l3-1.8a2 2 0 0 0 .97-1.71v-3.24a2 2 0 0 0-.97-1.71L17 10.5l-5 3Z" /><path d="m17 16.5-5-3" /><path d="m17 16.5 4.74-2.85" /><path d="M17 16.5v5.17" /><path d="M7.97 4.42A2 2 0 0 0 7 6.13v4.37l5 3 5-3V6.13a2 2 0 0 0-.97-1.71l-3-1.8a2 2 0 0 0-2.06 0l-3 1.8Z" /><path d="M12 8 7.26 5.15" /><path d="m12 8 4.74-2.85" /><path d="M12 13.5V8" />',
        ...
        // Agregados para que layouts/navigation.blade.php (el sidebar) use
        // esta misma fuente en vez de mantener su propio mapa aparte (que
        // no salía de lucide-static, sino tipeado/copiado a mano).
    ...
    public static function path(?string $nombre, string $fallback = 'chart'): string
    {
        return self::PATHS[$nombre] ?? self::PATHS[$fallback] ?? self::PATHS['chart'];
    }
}
